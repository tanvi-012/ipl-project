...
//             <MDBBtn color='secondary' onClick={() => {handleReset();handleCardClick();handleButtonClick("Batsman");}}style={{margin:'4px'}}>
//             Batsman
//             </MDBBtn>
...
//     setMilliseconds(30000);
//     setIsRunning(false);
//     setAllPlayersFinished(true); // Set the flag when all players are finished
//   };
...
//       const response = await axios.get(`http://localhost:5000/execute-query?category=${category}`);
//       setData(response.data);
//       setAllPlayersFinished(false); // Reset the flag when new players are fetched
//     } catch (error) {
//       console.error('Error:', error.message);
//     }
//   };
...
//             Batsman
//           </MDBBtn>
//           <MDBBtn color='secondary' onClick={() => { handleReset(); handleCardClick(); handleButtonClick("Bowler"); }} style={{ margin: '4px' }}>
//             Bowler
//           </MDBBtn>
//           <MDBBtn color='secondary' onClick={() => { handleReset(); handleCardClick(); handleButtonClick("All Rounder"); }} style={{ margin: '4px' }}>
//             All Rounder
//           </MDBBtn>
//           <MDBBtn color='secondary' onClick={() => { handleReset(); handleCardClick(); handleButtonClick("Batsman(w/k)"); }} style={{ margin: '4px' }}>
//             Wicketkeeper
//           </MDBBtn>
//         </MDBBtnGroup>
//       </MDBRow>
...
//               <MDBCardHeader>{selectedCategory}</MDBCardHeader>
//               <MDBCardBody>
//                 <MDBCardTitle>
//                   {data && data.length > 0 && (
//                     Object.entries(data[currentIndex]).map(([key, value]) => (
...
//             </MDBCard>
//           )}
//           {allPlayersFinished && <p>All players in the {selectedCategory} category have been displayed!</p>}
//         </MDBCol>
//       </MDBRow>
//     </MDBContainer>
//   );
